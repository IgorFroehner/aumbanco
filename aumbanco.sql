...
--
-- Host: localhost:3306
-- Generation Time: Jan 27, 2021 at 11:27 PM
...
--
-- Table structure for table `tb_cliente_fornecedor`
--

CREATE TABLE `tb_cliente_fornecedor` (
  `id` int NOT NULL,
  `cliente_fornecedor` varchar(40) DEFAULT NULL,
  `cnpj_cpf` varchar(40) DEFAULT NULL,
  ...
  `hora_alteracao` varchar(40) DEFAULT NULL,
  `login` varchar(40) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `tb_cliente_fornecedor`
--

INSERT INTO `tb_cliente_fornecedor` (`id`, `cliente_fornecedor`, `cnpj_cpf`, `nome`, `telefone`, `estado`, `cidade`, `bairro`, `rua`, `num`, `complemento`, `email`, `hora_alteracao`, `login`) VALUES
(1, 'cliente', '100.648.629-17', 'Artur Vieira', '(23)3645-1028', 'Acre', 'Acrelândia', 'Alto', 'Brasilio Celestino de Oliveira', '133', 'apt', '', '13:42 05/07/2018', 'adm'),
(2, 'cliente', '729.432.638-00', 'Rafael Pedro Santos ', '(47)9923-0930', 'Santa Catarina', 'Mafra', 'Centro', 'ten Ary Rauen', '333', 'casa', '', '13:47 05/07/2018', 'adm'),
(3, 'cliente', '693.667.177-21', 'Juliana Algusta Ribeiro', '(23)4343-4242', 'Paraná', 'Mandirituba', 'Centro', 'XV de novembro', '889', 'apt', 'asdf.asdf@asdf.com', '13:49 05/07/2018', 'adm'),
(4, 'fornecedor', '37.005.370/0001-21', 'Lojas Brasil', '(23)4234-2342', 'Acre', 'Acrelândia', 'wer', 'ten Ary Rauen', '1234', 'asdf', '', '13:51 05/07/2018', 'adm'),
(5, 'fornecedor', '08.584.886/0001-70', 'Juje Lojas Artificios', '(32)4234-2342', 'São Paulo', 'Santos', 'Centro', 'Artenes', '133', 'asdf', '', '13:53 05/07/2018', 'adm'),
(6, 'cliente', '635.147.960-68', 'igor', '(12)3312-3123', 'Acre', 'Acrelândia', 'asdf', 'asdf', '133', '22', 'ademds@hotma.com', '13:55 05/07/2018', 'adm'),
(7, 'cliente', '135.542.755-06', 'igor', '(12)3123-1231', 'Acre', 'Capixaba', 'Centro', 'asdf', '123', 'asdf', '', '13:55 05/07/2018', 'adm');
...
CREATE TABLE `tb_compras` (
  ...
  `n_notafiscal` varchar(50) DEFAULT NULL,
...
INSERT INTO `tb_compras` (`id_compra`, `id_fornecedor`, `datac`, `n_notafiscal`, `valor_total`) VALUES
(1, 5, '05/07/2018', '98090878', 1.00);
...
CREATE TABLE `tb_entrada` (
  ...
  `data_entrada` varchar(30) DEFAULT NULL,
...
INSERT INTO `tb_entrada` (`id_entrada`, `login`, `hora_entrada`, `hora_saida`, `data_entrada`, `data_saida`) VALUES
(1, 'adm', '13:37', '13:57', '05/07/2018', '05/07/2018'),
(2, 'adm', '14:01', '14:01', '05/07/2018', '05/07/2018'),
(3, 'adm', '14:07', '14:08', '05/07/2018', '05/07/2018'),
(4, 'adm', '14:09', '14:10', '05/07/2018', '05/07/2018'),
(5, 'adm', '14:11', '14:12', '05/07/2018', '05/07/2018');
...
CREATE TABLE `tb_produtos` (
  ...
  `hora_alteracao` varchar(20) DEFAULT NULL,
...
INSERT INTO `tb_produtos` (`id_prod`, `nome`, `quantidade_estoque`, `unidade_medida`, `valor`, `hora_alteracao`, `login`) VALUES
(1, 'abacate', NULL, 'Kilo (Kg)', 7.00, '13:37 05/07/2018', 'adm'),
(2, 'Abajur', -1, 'Unidade', 13.00, '13:38 05/07/2018', 'adm'),
(3, 'Lampada Led', 1, 'Unidade', 3.00, '13:38 05/07/2018', 'adm'),
(4, 'Parafuso Pequeno', NULL, 'Unidade', 9.00, '13:39 05/07/2018', 'adm'),
(5, 'Parafuso Medio', NULL, 'Unidade', 20.00, '13:39 05/07/2018', 'adm'),
(6, 'Parafuso Grande', NULL, 'Kilo (Kg)', 30.00, '13:40 05/07/2018', 'adm'),
(7, 'Cerca Elétrica', NULL, 'Metros Quadrados (m²)', 19.00, '13:40 05/07/2018', 'adm'),
(8, 'Antena Digital', NULL, 'Unidade', 110.00, '13:40 05/07/2018', 'adm'),
(9, 'Monitor Led 25\"', NULL, 'Unidade', 599.00, '13:41 05/07/2018', 'adm');

-- --------------------------------------------------------

--
-- Table structure for table `tb_produtos_compra`
--

CREATE TABLE `tb_produtos_compra` (
  `id_compra` int NOT NULL,
...
--
-- Dumping data for table `tb_produtos_compra`
--

INSERT INTO `tb_produtos_compra` (`id_compra`, `id_produto`, `quantidade`, `preco`) VALUES
(1, 3, 1, 1.00);
...
INSERT INTO `tb_produtos_venda` (`id_venda`, `id_produto`, `quantidade`, `preco`) VALUES
(1, 2, 1, 13.00);
...
INSERT INTO `tb_usuarios` (`nome`, `login`, `senha`, `permissao`) VALUES
('Administrador', 'adm', '202cb962ac59075b964b07152d234b70', 'administrador'),
('artur', 'artur', '202cb962ac59075b964b07152d234b70', 'vendedor'),
('igor', 'igor', '202cb962ac59075b964b07152d234b70', 'vendedor');
...
INSERT INTO `tb_vendas` (`id_venda`, `id_cliente`, `datav`, `valor_total`) VALUES
(1, 6, '05/07/2018', 13.00);
...
--
-- Indexes for table `tb_cliente_fornecedor`
--
ALTER TABLE `tb_cliente_fornecedor`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `tb_produtos_compra`
--
ALTER TABLE `tb_produtos_compra`
...
--
-- AUTO_INCREMENT for table `tb_cliente_fornecedor`
--
ALTER TABLE `tb_cliente_fornecedor`
...
--
-- Constraints for table `tb_produtos_compra`
--
ALTER TABLE `tb_produtos_compra`
  ADD CONSTRAINT `tb_produtos_compra_ibfk_1` FOREIGN KEY (`id_compra`) REFERENCES `tb_compras` (`id_compra`),
  ADD CONSTRAINT `tb_produtos_compra_ibfk_2` FOREIGN KEY (`id_produto`) REFERENCES `tb_produtos` (`id_prod`);

--
-- Constraints for table `tb_produtos_venda`
--
ALTER TABLE `tb_produtos_venda`
  ADD CONSTRAINT `tb_produtos_venda_ibfk_1` FOREIGN KEY (`id_venda`) REFERENCES `tb_vendas` (`id_venda`),
  ADD CONSTRAINT `tb_produtos_venda_ibfk_2` FOREIGN KEY (`id_produto`) REFERENCES `tb_produtos` (`id_prod`);
COMMIT;
