 ...
 * @author AlunoRNO
 */
public class TelaComprar extends javax.swing.JDialog {
    ...
    private static javax.swing.JComboBox combofornecedores;
    ...
    public TelaComprar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jTbpesquisa.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Nome", "Preço Venda", "Qtd Estoque"
            }
        ) {
        ...
        jDateChooser1.setMaxSelectableDate(new java.util.Date(253370775699000L));
        ...
        jCbFornecedor.setFont(new java.awt.Font("Aharoni", 0, 18)); // NOI18N
        ...
        jTnotafiscal.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
                    ...
                    .addGroup(jPnFundoLayout.createSequentialGroup()
                        .addGroup(jPnFundoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPnFundoLayout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(jCbFornecedor, javax.swing.GroupLayout.PREFERRED_SIZE, 453, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPnFundoLayout.createSequentialGroup()
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPnFundoLayout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(jTnotafiscal, javax.swing.GroupLayout.PREFERRED_SIZE, 192, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    ...
                    .addGroup(jPnFundoLayout.createSequentialGroup()
                        .addGroup(jPnFundoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPnFundoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                .addComponent(jTnotafiscal, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(jLabel8))
                            .addGroup(jPnFundoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addGroup(jPnFundoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jLabel7)
                            .addComponent(jCbFornecedor, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(jPnFundoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPnFundoLayout.createSequentialGroup()
                                .addGroup(jPnFundoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
    ...
    private void jBtNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovoActionPerformed
        ...
        combofornecedores = jCbFornecedor;
        combofornecedores.removeAllItems();
        combofornecedores.addItem("Selecione");
        try {
        ...
        int ultimoCod = modelo.getId_compra() + 1;
    ...
    public void tabela(Compras modelo) {
        ...
        carrinho.addRow(new Object[]{
            ...
            modelo.getQuantidade() * modelo.getValor()
        });
    }

    public void manda(Compras modelo) {
        limpacampos();

        jTcod.setText("" + modelo.getId_compra());
        jTnotafiscal.setText("" + modelo.getN_notafiscal());
        //manda a data para o Date chooser
        try {
            jDateChooser1.setDate(new SimpleDateFormat("dd/MM/yyyy").parse(modelo.getDatac()));
        ...
        jCbFornecedor.setSelectedItem(modelo.getFornecedor());

        //consulta para tabela produtos venda (CARRINHO)
        try {
            dao.consultaProdutosCompra(modelo);
        } catch (HeadlessException | ParseException ex) {
            Logger.getLogger(TelaVender.class.getName()).log(Level.SEVERE, null, ex);
        }

        jTpreco.setText("" + modelo.getValor_total());
    ...
    public void cadastraCompra() {
        ...
        if (jCbFornecedor.getSelectedItem().equals("Selecione")) {
            ...
            if (carrinho.getRowCount() == 0) {
                ...
                if (resultado == JOptionPane.YES_OPTION) {
                    ...
                    //seta CNPJ do cliente cortando a string para pesquisar o id no banco
                    String cliente = jCbFornecedor.getSelectedItem().toString();
                    String cortaCpf = cliente.substring(cliente.length() - 18);
                    System.out.println(cortaCpf);
                    modelo.setCnpj_cpf(cortaCpf);

                    modelo.setN_notafiscal(jTnotafiscal.getText());
                    modelo.setId_compra(Integer.parseInt(jTcod.getText()));
                    modelo.setDatac("" + new SimpleDateFormat("dd/MM/yyyy").format(jDateChooser1.getDate()));
                    modelo.setValor_total(pTotal);

                    try {
                        dao.cadastra_Compra(modelo);
                    ...
                    do {
                        ...
                        modelo.setValor((double) carrinho.getValueAt(y, 2));
                        modelo.setQuantidade((int) carrinho.getValueAt(y, 3));

                        try {
                            dao.cadastra_ProdutosCompra(modelo);
    ...
    public void combobox(Pessoas modelo) {
        combofornecedores.addItem(modelo.getNomePessoa() + " " + modelo.getCPF_CNPJ());
    }
    ...
    public void limpacampos() {
        ...
        jTpesquisa.setText("");
        jSelecionar.setSelectedIndex(1);
    }
    ...
    public void carrinho() {
        ...
        panelQuant.setLayout(new GridLayout(2, 1));
        ...
        panelQuant.add(label);
        panelQuant.add(spiner);

        //mostrando na tela a mensagem para selecionar a quantidade
        int resultadoQuant = JOptionPane.showConfirmDialog(null, panelQuant, "Quantidade", JOptionPane.OK_CANCEL_OPTION);
        ...
        if (qCompra == 0) {
            ...
            if (resultadoQuant == JOptionPane.OK_OPTION) {

                //criando a mensagem para selecionar quantidade
                JPanel panelPreco = new JPanel();
                panelPreco.setLayout(new GridLayout(2, 1));
                JLabel labelPreco = new JLabel();
                labelPreco.setFont(new java.awt.Font("Tahoma", 1, 18));
                labelPreco.setText("Digite o preço pagado pelo produto");
                JTextField textPreco = new JTextField();
                textPreco.setFont(new java.awt.Font("Tahoma", 1, 18));

                panelPreco.add(labelPreco);
                panelPreco.add(textPreco);

                //mostrando na tela a mensagem para selecionar a quantidade
                int resultadoPreco = JOptionPane.showConfirmDialog(null, panelPreco, "Preço", JOptionPane.OK_CANCEL_OPTION);
                Double preco = Double.parseDouble(textPreco.getText());
                
                if (resultadoPreco == JOptionPane.OK_OPTION) {
                    ...
                    //multiplica o preco pela quantidade
                    Double preco_total = preco * qCompra;

//                adiciona os dados no carrinho
                    carrinho.addRow(new Object[]{codPesquisa, nome, preco, qCompra, preco_total});
